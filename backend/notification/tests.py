...
class BaseTest(APITestCase):
    def setUp(self):
        ...
        self.calender = CalenderModel.objects.create(user=self.user1, title="test", start_date="2021-01-01", end_date="2021-01-01", color="red")
...
class TestCalender(BaseTest):
    def test_add_calender_event(self):
        ...
        self.assertEqual(url, '/api/notification/addevent/')
    ...
    def test_get_calender_event(self):
        ...
        self.assertEqual(url, '/api/notification/calendar/')
    ...
    def test_delete_calender_event(self):
        ...
        self.assertEqual(url, f'/api/notification/delete_event/{self.calender.id}/')
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)

    def test_today_event(self):
        url = reverse('getTodayEvent')
        response = self.client.get(url)
        self.assertEqual(url, '/api/notification/getTodayEvent/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class TestNotes(BaseTest):
    def test_add_notes(self):
        ...
        response = self.client.post(url, data)
        self.assertEqual(url, '/api/notification/addNotes/')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_get_notes(self):
        ...
        response = self.client.get(url)
        self.assertEqual(url, '/api/notification/getNotes/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_delete_notes(self):
        ...
        response = self.client.delete(url)
        self.assertEqual(url, f'/api/notification/deleteNotes/{self.note.id}/')
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
    ...
    def test_update_notes(self):
        ...
        self.assertEqual(url, f'/api/notification/updateNotes/{self.note.id}/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_update_notes_title(self):
        ...
        response = self.client.put(url, data)
        self.assertEqual(url, f'/api/notification/updateNotesTitle/{self.note.id}/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data['title'], 'test')
...
class TestNotification(BaseTest):
    def test_get_notification_by_user(self):
        ...
        response = self.client.get(url)
        self.assertEqual(url, f'/api/notification/get_notification_by_user/{self.user1.username}/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    def test_update_notification(self):
        url = reverse('update_notification', args=[self.user1.username])
        response = self.client.put(url)
        self.assertEqual(url, f'/api/notification/update_notification/{self.user1.username}/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
