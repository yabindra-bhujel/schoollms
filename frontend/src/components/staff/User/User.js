              ...
              <TableBody>
                {userlist.map((user) => (
                  <TableRow key={user.username}>
                    ...
                    <TableCell
                      style={{ color: user.is_superuser ? "green" : "red" }}
                    >
                      {user.is_superuser ? "Yes" : "No"}
                    </TableCell>
                    <TableCell
                      style={{ color: user.is_staff ? "green" : "red" }}
                    >
                      {user.is_staff ? "Yes" : "No"}
                    </TableCell>
                    <TableCell
                      style={{ color: user.is_teacher ? "green" : "red" }}
                    >
                      {user.is_teacher ? "Yes" : "No"}
                    </TableCell>
                    <TableCell
                      style={{ color: user.is_student ? "green" : "red" }}
                    >
                      {user.is_student ? "Yes" : "No"}
                    </TableCell>
                    <TableCell
                      style={{ color: user.is_active ? "green" : "red" }}
                    >
